...
public class Epvar {
	...
	public double annmax_livestemc; /*
									 * (kgC/m2) annual maximum daily livestem C
									 */
	public double annmax_livecrootc; /*
										 * (kgC/m2) annual maximum daily livecroot
										 * C
										 */
	...
	public double dlmr_area_sun; /*
									 * (umolC/m2projected leaf area/s) sunlit leaf
									 * MR
									 */
	public double dlmr_area_shade;/*
									 * (umolC/m2projected leaf area/s) shaded leaf
									 * MR
									 */
	public double gl_t_wv_sun; /*
								 * (m/s) leaf-scale conductance to transpired
								 * water
								 */
	public double gl_t_wv_shade; /*
									 * (m/s) leaf-scale conductance to transpired
									 * water
									 */
	public double assim_sun; /* (umol/m2/s) sunlit assimilation per unit pLAI */
	public double assim_shade; /*
								 * (umol/m2/s) shaded assimilation per unit pLAI
								 */
	/* decomp variables */
	...
	public double daily_gross_nmin; /*
									 * (kgN/m2/d) daily gross N mineralization
									 */
	public double daily_gross_nimmob; /*
										 * (kgN/m2/d) daily gross N immobilization
										 */
	...
	public Epvar(double dDay_leafc_litfall_increment, double dDay_frootc_litfall_increment,
			double dDay_livestemc_turnover_increment, double dDay_livecrootc_turnover_increment, double dAnnmax_leafc,
			double dAnnmax_frootc, double dAnnmax_livestemc, double dAnnmax_livecrootc, double dDsr, double dProj_lai,
			double dAll_lai, double dPlaisun, double dPlaishade, double dSun_proj_sla, double dShade_proj_sla,
			double dPsi, double dVwc, double dDlmr_area_sun, double dDlmr_area_shade, double dGl_t_wv_sun,
			double dGl_t_wv_shade, double dAssim_sun, double dAssim_shade, double dT_scalar, double dW_scalar,
			double dRate_scalar, double dDaily_gross_nmin, double dDaily_gross_nimmob, double dDaily_net_nmin,
			double dFpi, double dM_tmin, double dM_psi, double dM_co2, double dM_ppfd_sun, double dM_ppfd_shade,
			double dM_vpd, double dM_final_sun, double dM_final_shade, double dGl_bl, double dGl_c, double dGl_s_sun,
			double dGl_s_shade, double dGl_e_wv, double dGl_sh, double dGc_e_wv, double dGc_sh, double dYtd_maxplai) {
