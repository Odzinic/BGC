...
public class Daily_Allocation {
	...
	public int daily_allocation(CFlux cf, CState cs, NFlux nf, NState ns, Epconst epc, Epvar epv,
		...
		double actual_immob = 0;
		double plant_nalloc, plant_calloc;
		double fpi=0.0;
		double plant_remaining_ndemand;
		double excess_c;
		int nlimit;
		double cn_l1 = 0,cn_l2 = 0,cn_l4 = 0,cn_s1,cn_s2,cn_s3,cn_s4;
		...
		double DAYSCRECOVER = Constant.DAYSCRECOVER.getValue();
		double GRPERC = Constant.GRPERC.getValue();
		double GRPNOW = Constant.GRPNOW.getValue();
		double DAYSNDEPLOY = Constant.DAYSNDEPLOY.getValue();
		double MODE_SPINUP = Constant.MODE_SPINUP.getValue();
		double MODE_MODEL = Constant.MODE_MODEL.getValue();
		double BULK_DENITRIF_PROPORTION = Constant.BULK_DENITRIF_PROPORTION.getValue();
