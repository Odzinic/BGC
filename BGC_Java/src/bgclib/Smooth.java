...
public class Smooth {
    ...
    public boolean run_avg(final List<Double> input, List<Double> output, int n, int w, int w_flag) {
    ...
    public boolean boxcar_smooth(List<Double> input, List<Double> output, int n, int w, int w_flag) {
