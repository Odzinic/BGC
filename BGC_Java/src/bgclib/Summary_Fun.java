...
public class Summary_Fun {
	...
	public int csummary(CFlux cf, CState cs, Summary summary) {
		...
		gr = cf.cpool_leaf_gr + cf.cpool_leaf_storage_gr + cf.transfer_leaf_gr + cf.cpool_froot_gr
				...
				+ cf.transfer_livestem_gr + cf.cpool_deadstem_gr + cf.cpool_deadstem_storage_gr
				+ cf.transfer_deadstem_gr + cf.cpool_livecroot_gr + cf.cpool_livecroot_storage_gr
				+ cf.transfer_livecroot_gr + cf.cpool_deadcroot_gr + cf.cpool_deadcroot_storage_gr
				+ cf.transfer_deadcroot_gr;
		npp = gpp - mr - gr;
		...
		summary.daily_litfallc = cf.m_leafc_to_litr1c + cf.m_leafc_to_litr2c + cf.m_leafc_to_litr3c
				...
				+ cf.m_livecrootc_storage_to_litr1c + cf.m_deadcrootc_storage_to_litr1c + cf.m_leafc_transfer_to_litr1c
				+ cf.m_frootc_transfer_to_litr1c + cf.m_livestemc_transfer_to_litr1c + cf.m_deadstemc_transfer_to_litr1c
				+ cf.m_livecrootc_transfer_to_litr1c + cf.m_deadcrootc_transfer_to_litr1c + cf.m_livestemc_to_cwdc
				+ cf.m_deadstemc_to_cwdc + cf.m_livecrootc_to_cwdc + cf.m_deadcrootc_to_cwdc
				+ cf.m_gresp_storage_to_litr1c + cf.m_gresp_transfer_to_litr1c + cf.leafc_to_litr1c + cf.leafc_to_litr2c
				+ cf.leafc_to_litr3c + cf.leafc_to_litr4c + cf.frootc_to_litr1c + cf.frootc_to_litr2c
	...
	public int wsummary(WState ws, WFlux wf, Summary summary) {
		 ...
		 * flux variables. Assigns daily outflow to summary struct. Added: WMJ,
		 * 26 Oct 04
		 */
